        ...
        <template #default="scope">
          <el-space alignment="start" :size="20">
            <el2-button
              ...
              >下载</el2-button
            >
            <el2-button link @click="handlePreview(scope.row)" type="primary"
              >预览</el2-button
            >
            <el2-button
              v-if="!props.disabled"
...
<script lang="ts" setup>
  ...
  const uploadFileUrl = ref(import.meta.env.VITE_APP_BASE_API + '/jnf-file/actions/single-upload/') // 上传文件服务器地址
